const contractAddress = "0x6eA9a9877A78b687CacaEf0C6A0Cc801C74E4c81"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Medieval Mongers NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Medieval Mongers NFT Project is a cool collection of different medieval sellers with their coin bag. ';
...
const p_presale_coming_soon = "We are working hard to launch the Medieval Mongers NFT Collection. Stay tuned for updates!";
